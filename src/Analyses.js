 ...
 const sog = currentShotData?.totals?.all?.shotsOnGoal
  ...
  const EDGE_ZONES = [
    { idx: 12, tx: 2,   ty: 33,  lx: 25,  ly: 75,
      d: 'M9.40101 1.57176C9.55325 1.27053 9.73045 0.982587 10.4712 0.3499H32.3784C32.4446 0.975807 32.5108 1.30689 32.7543 1.751C36.2857 14.6735 43.7983 26.3803 54.1638 35.2101C54.6935 35.6737 55.2895 36.1372 55.8854 36.6007C56.1413 36.7829 56.3846 36.982 56.7475 37.2761L26.9486 76.927L0.726569 112.022V33.8196C0.721648 22.4932 3.71446 11.3672 9.40101 1.57176Z' },
    { idx: 5, tx: 34, ty: 34, lx: 58, ly: 52,
      d: 'M0.7543 0.751H51.8242L24.7475 36.2761C24.7475 36.2761 17.3968 31.366 10.4116 20.8881C3.42631 10.4102 0.7543 0.751 0.7543 0.751Z' },
    { idx: 0, tx: 59, ty: 33, lx: 101, ly: 69,
      d: 'M57.7134 0.9242L28.3545 0.9211L0.378906 38.3534C2.10057 39.6116 3.87154 42.345 10.3579 45.3387C16.8442 48.3324 33.8084 53.8208 46.781 52.8229C59.7537 51.825 69.2945 48.2524 75.72 44.3408C82.1454 40.4292 82.8163 39.8126 84.4039 38.1393L57.7134 0.9242Z' },
    ...
    { idx: 7, tx: 117, ty: 33, lx: 145, ly: 52,
      d: 'M52.1857 1.4531L-0.2866 0.9242L27.6971 36.3554C27.6971 36.3554 35.1813 31.366 42.1665 20.8881C49.1518 10.4102 52.1857 1.4531 52.1857 1.4531Z' },
    { idx: 13, tx: 145, ty: 34, lx: 180, ly: 75, hatch: true,
      d: 'M47.2385 1.8369C47.1061 1.57203 46.9074 1.30716 46.1532 -0.0173L24.1857 0.4531C24.6585 1.24094 24.5923 1.57203 24.526 1.8369C20.8929 14.8168 13.4966 26.4297 3.27034 35.2104C2.74061 35.6739 2.14465 36.1375 1.5487 36.601C1.28383 36.7996 1.08518 36.9983 0.820312 37.1969L29.4268 77.0232L55.7143 111.36V33.8198C55.7227 22.6026 52.801 11.5778 47.2385 1.8369Z' },
    { idx: 3, tx: 27, ty: 72, lx: 57, ly: 105,
      d: 'M54.6905 11.1456L37.7023 62.6331L38.0766 62.8693C23.5318 58.7263 11.1492 50.4491 0.488281 40.9138L31.2793 0.190186C38.2132 5.35669 46.0181 9.23673 54.6905 11.1456Z' },
    { idx: 2, tx: 65, ty: 82, lx: 101, ly: 116,
      d: 'M74.0925 51.4821C62.8805 55.8045 49.1735 57.3937 35.7314 57.3937C23.7477 57.4086 11.8443 55.4396 0.0766 52.8693H0.4375L16.6904 1.1456C23.2847 2.40487 29.7245 3.29618 36.1949 3.29414C43.3121 3.29822 50.3889 2.22665 57.2159 -0.0275L74.0925 51.4821Z' },
    { idx: 4, tx: 122, ty: 70, lx: 145, ly: 105,
      d: 'M0.2159 11.9725L15.9465 61.8497L17.0925 63.4821C30.118 58.0205 41.2368 50.9193 52.4268 41.0232L21.4039 1.1393C14.182 6.07599 8.55463 9.49463 0.2159 11.9725Z' },
    { idx: 9, tx: 2, ty: 114, lx: 30, ly: 155,
      d: 'M63.0766 20.8693L60.1104 31.4137L59.8456 32.1421L47.7419 68.5814L48.2549 68.2799H2.51622C1.65541 68.3166 0.860811 67.7206 0.5332 66.9854V36.4661L22.1592 6.49746L22.2254 6.43124L26.7281 0.47168C31.7535 4.21383 38.9179 9.74545 42.9095 12.2402C46.9011 14.7349 56.8503 19.8388 63.0766 20.8693Z' },
    { idx: 11, tx: 50, ty: 133, lx: 101, ly: 165,
      d: 'M106.178 48.6473L89.0925 0.4821C89.0925 0.4821 75.2436 7.20841 52.7909 7.20841C30.3383 7.20841 16.8667 1.71999 16.8667 1.71999L0.2549 49.2799H106.178Z' },
    { idx: 10, tx: 138, ty: 113, lx: 170, ly: 155,
      d: 'M1.0925 20.4821L3.88959 31.4157L4.15445 32.144L16.2581 68.5834L16.3905 68.9145H61.4838C62.3446 68.3185 63.1392 67.7226 64.289 67.4864V36.468L41.8408 6.49941L41.7746 6.43319L37.2719 0.473633C32.2465 4.21578 25.0821 9.74741 21.0905 12.2421C17.0989 14.7369 7.14973 19.8408 1.0925 20.4821Z' },
    { idx: 14, tx: 3, ty: 180, lx: 101, ly: 201, hatch: true,
      d: 'M199.289 0.4864V30.7102L0.0664062 31.0413L-0.4668 0.9854H199.578Z' },
    ...
    { idx: 8, tx: 141, ty: 3, lx: 159.05, ly: 20.5, hatch: true,
      d: 'M0.332031 29.9894L50.1532 30.9827C49.2679 29.5331 48.9806 29.091 48.6705 28.665C47.9367 27.4763 47.1411 26.327 46.2867 25.2217C45.7719 24.4873 45.2194 23.78 44.6313 23.1028C40.4477 17.9899 35.4872 13.5657 29.9311 9.99175C21.0524 4.28415 10.8653 0.934027 0.332031 0.257812V29.9894Z' },
  ];
                  ...
                  {EDGE_ZONES.map((z) => {
                    ...
                    return (
                      <g key={z.idx} transform={`translate(${z.tx},${z.ty})`}>
                        <path d={z.d} fill={orangeRed(pct)} stroke="#7a1f0f" strokeWidth="2" strokeOpacity="1" strokeLinejoin="round" />
                        {z.hatch && <path d={z.d} fill="url(#hatchZoneP)" />}
                      </g>
                    );
                  })}
                  <path d={BEHIND_NET_D} fill="#0a3a52" stroke="#7a1f0f" strokeWidth="2" strokeOpacity="1" strokeLinejoin="round" />
